...
func createDoc(t time.Time) {
	...
	docx1.Replace("speaker2FirstLastName", roles.speaker1, -1)
	...
	docx1.Replace("speaker3FirstLastName", roles.speaker1, -1)
	...
	docx1.Replace("speaker4FirstLastName", roles.speaker1, -1)
